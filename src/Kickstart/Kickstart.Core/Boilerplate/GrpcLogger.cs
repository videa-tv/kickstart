...
{
    /// <summary>
    /// Grpc logger implementation that uses .NET Core logging capabilities.
    /// It allows to plugin any logger externally that is compatible with .NET Core logging api like Serilog
    /// </summary>
